				...
				<div class="information_activity">
					...
					<p class="car_Goodprice">
						...
						<span>
							￥
							<i>{{groupPrice}}</i>
							<span>抵扣<s>￥{{originalPrice}}</s></span>
						</span>
					</p>
				</div>
			</div>
	    ...
	    methods:{
	    	carDetailHttpData(){	 
				...
				this.$axios(this.returndata).then((response) => {
					_this.chitDetail = response.response_data.activitinfos["0"];
					_this.groupPrice = _this.chitDetail.groupPrice;
					_this.originalPrice = _this.chitDetail.originalPrice;
					_this.activityTitle = _this.chitDetail.activityTitle;
					_this.dealerName = _this.chitDetail.dealerName;
					_this.dealerAddress = _this.chitDetail.address;
					_this.activityDescribe = _this.chitDetail.activityDescribe;
					_this.loginId = _this.chitDetail.dealerCode;
					_this.logoUrl = _this.chitDetail.logoUrl;
